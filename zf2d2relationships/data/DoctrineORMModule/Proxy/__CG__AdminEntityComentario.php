 ...
 */
class Comentario extends \Admin\Entity\Comentario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\Comentario' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Comentario' . "\0" . 'nome', '' . "\0" . 'Admin\\Entity\\Comentario' . "\0" . 'site', '' . "\0" . 'Admin\\Entity\\Comentario' . "\0" . 'conteudo', '' . "\0" . 'Admin\\Entity\\Comentario' . "\0" . 'comentario', '' . "\0" . 'Admin\\Entity\\Comentario' . "\0" . 'children', '' . "\0" . 'Admin\\Entity\\Comentario' . "\0" . 'dtaInc', '' . "\0" . 'Admin\\Entity\\Comentario' . "\0" . 'post');
        }
