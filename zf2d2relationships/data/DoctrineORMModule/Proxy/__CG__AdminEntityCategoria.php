 ...
 */
class Categoria extends \Admin\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\Categoria' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Categoria' . "\0" . 'nome', '' . "\0" . 'Admin\\Entity\\Categoria' . "\0" . 'slug');
        }
