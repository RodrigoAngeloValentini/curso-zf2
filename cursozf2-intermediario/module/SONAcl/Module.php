        ...
        return array(
            'factories' => array(
                ...
                'SONAcl\Service\Role' => function ($sm){
                    return new \SONAcl\Service\Role($sm->get('Doctrine\ORM\EntityManager'));
                },
                'SONAcl\Service\Resource' => function ($sm){
                    return new \SONAcl\Service\Resource($sm->get('Doctrine\ORM\EntityManager'));
                },
                'SONAcl\Service\Privilege' => function ($sm){
                    return new \SONAcl\Service\Privilege($sm->get('Doctrine\ORM\EntityManager'));
                },
