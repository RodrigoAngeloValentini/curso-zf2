 ...
 */
class Resource extends \Admin\Entity\Resource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\Resource' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Resource' . "\0" . 'nome');
        }
