 ...
 */
class Perfil extends \Admin\Entity\Perfil implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\Perfil' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Perfil' . "\0" . 'nome', '' . "\0" . 'Admin\\Entity\\Perfil' . "\0" . 'perfil', '' . "\0" . 'Admin\\Entity\\Perfil' . "\0" . 'children');
        }
